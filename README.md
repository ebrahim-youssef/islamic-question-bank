...
قيمته `2`، وهي تشمل قسم مجموعات الإنجاز. أُضيف القسم دون رفع الرقم عن قصد: الرقم
موجود ليختار المستهلك المحلِّل المناسب، ولا مستهلك بعد — التطبيق لم يبدأ قراءة
البيان أصلًا. فرفعه كان سيسجّل كسر توافق لم يقع.

هذا ينتهي يوم يقرأ التطبيق البيان فعلًا. بعدها أي تغيير في الحقول المطلوبة يلزمه
رقم جديد، لأن نسخة قديمة من التطبيق ستظل تعمل على أجهزة الناس بينما يتغير الفرع
تحتها.
